...
namespace CURD_Using_Dapper_Framework.Models
{
    public class Product
    {
        ...
        public static string ConnectionString = "Server=DESKTOP-8FSFFAE\\SQLEXPRESS;Database=SHAURYA;Integrated Security=True;";
    }
